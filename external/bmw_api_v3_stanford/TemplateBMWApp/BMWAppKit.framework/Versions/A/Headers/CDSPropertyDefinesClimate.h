 ...
 */
extern NSString * const CDSClimateACCompressor;
...
/*!
 @define     climate.airConditionerCompressor
 @abstract   Stored in response key "CDSClimateAirConditionerCompressor" as a dictionary with keys "actualTorque" and "dualMode". actualTorque is returned as unsigned byte (0..255, unit is 0.5, domain is 0.30 Nm)
 dualMode is returned as enumeration with possible values: CDSClimateAirConditionerCompressorDualMode_OFF, CDSClimateAirConditionerCompressorDualMode_ON, DSClimateAirConditionerCompressorDualMode_INVALID
 */
extern NSString * const CDSClimateAirConditionerCompressor;
enum eCDSClimateAirConditionerCompressorDualMode
{
    CDSClimateAirConditionerCompressorDualMode_OFF = 0,
    CDSClimateAirConditionerCompressorDualMode_ON = 1,
    CDSClimateAirConditionerCompressorDualMode_INVALID = 3
};
 ...
 */
extern NSString * const CDSClimateACHeatFlux;
 ...
 */
extern NSString * const CDSClimateACMode;
 ...
 */
extern NSString * const CDSClimateACSystemTemperatures;
 ...
 */
extern NSString * const CDSClimateDriverSettings;
...
/*!
 ...
 automaticblower is returned as an enumeration with possible values: CDSClimateSettingsAutoBlower_OFF, CDSClimateSettingsAutoBlower_ON, CDSClimateSettingsAutoBlower_RESERVED, CDSClimateSettingsAutoBlower_INVALID
 */
extern NSString * const CDSClimatePassengerSettings;
 ...
 */
extern NSString * const CDSClimateSeatHeatDriver;
 ...
 */
extern NSString * const CDSClimateSeatHeatPassenger;
 ...
 */
extern NSString * const CDSClimateResidualHeat;
